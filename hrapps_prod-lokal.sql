...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2025 at 04:23 PM
...
('hr_application_cache_admin@example.com|::1', 'i:1;', 1765818468),
('hr_application_cache_admin@example.com|::1:timer', 'i:1765818468;', 1765818468),
('hr_application_cache_hr@example.com|127.0.0.1', 'i:1;', 1765896972),
('hr_application_cache_hr@example.com|127.0.0.1:timer', 'i:1765896972;', 1765896972);
...
--
-- Table structure for table `category_approvals`
--
...
--
-- Table structure for table `departments_v2`
--
...
--
-- Table structure for table `document_identities`
--
...
(3, 'Employee 3', 'employee3@example.com', '081234567893', 'Street 3', NULL, '2022-01-01 05:00:00', 1, 4, 2, 'active', 6000000.00, '2025-12-06 11:13:32', '2025-12-16 07:59:20', '2025-12-16 07:59:20'),
...
(7, 'adada', 'tes@example.com', 'adada', 'adada', '1990-12-31 17:00:00', '2025-12-18 17:00:00', 4, 3, NULL, 'active', 300000.00, '2025-12-19 09:46:57', '2025-12-19 09:46:57', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `employees_v2`
--
...
--
-- Dumping data for table `employees_v2`
--

INSERT INTO `employees_v2` (`employee_id`, `nik`, `emp_code`, `fullname`, `email`, `phone`, `npwp`, `place_of_birth`, `date_of_birth`, `gender`, `religion`, `marital_status`, `address`, `join_date`, `employee_status`, `foundation_id`, `education_level_id`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 'EMP-00001', 'Administrator', 'admin@example.com', '081234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-06 11:13:31', '2025-12-06 11:13:31'),
(2, NULL, 'EMP-00002', 'John Manager', 'manager@example.com', '081234567891', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-06 11:13:31', '2025-12-06 11:13:31'),
(4, NULL, 'EMP-00004', 'Employee 4', 'employee4@example.com', '081234567894', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-06 11:13:32', '2025-12-06 11:20:29'),
(5, NULL, 'EMP-00005', 'Employee 5', 'employee5@example.com', '081234567895', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-06 11:13:32', '2025-12-06 11:13:32'),
(6, NULL, 'EMP-00006', 'Sasa Marinir', 'hr@aratechnology.id', '0765687989767', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-06 11:34:53', '2025-12-06 12:36:15'),
(7, NULL, 'EMP-00007', 'adada', 'tes@example.com', 'adada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-12-19 09:46:57', '2025-12-19 09:46:57');
...
INSERT INTO `employee_positions` (`id`, `employee_id`, `position_id`, `department_id`, `start_date`, `end_date`, `is_active`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 2, '2020-01-01', NULL, 1, 'active', '2025-12-19 08:45:47', '2025-12-19 09:32:06'),
(2, 2, 3, 1, '2021-01-01', NULL, 1, 'active', '2025-12-19 08:45:47', '2025-12-19 09:32:06'),
(3, 4, 4, 4, '2022-01-01', NULL, 1, 'active', '2025-12-19 08:45:47', '2025-12-19 09:32:06'),
(4, 5, 1, 4, '2022-01-01', NULL, 1, 'active', '2025-12-19 08:45:47', '2025-12-19 09:32:06'),
(5, 6, 1, 1, '2025-12-01', NULL, 1, 'active', '2025-12-19 08:45:47', '2025-12-19 09:32:06'),
(6, 7, 3, 4, '2025-12-19', NULL, 1, 'active', '2025-12-19 09:46:57', '2025-12-19 09:46:57');
...
INSERT INTO `foundations` (`foundation_id`, `foundation_name`, `email`, `phone`, `address`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Main HRIS Foundation', 'admin@example.com', NULL, NULL, 'active', '2025-12-19 08:45:47', '2025-12-19 08:45:47');
...
(1, 3, 'Ballpoint Pens', NULL, 100, NULL, NULL, 'active', '2025-12-06 11:14:17', '2025-12-16 07:59:44'),
...
(2, 4, 'sick', '2025-12-04 11:13:57', '2025-12-05 11:13:57', 'approved', '2025-12-06 11:13:57', '2025-12-16 08:35:45', '2025-12-16 08:35:45'),
...
--
-- Table structure for table `list_menu_features`
--
...
(22, '2025_12_13_000000_add_gps_and_worktype_to_presences_table', 2),
(23, '2025_12_11_153908_add_signature_reason_to_signatures_table', 3),
(24, '2025_12_18_184755_change_signature_hash_to_text_in_signatures_table', 3),
(25, '2025_12_19_000000_create_gohr2_parallel_schema', 3),
(26, '2025_12_19_132422_drop_unique_index_from_signatures_table', 3),
(27, '2025_12_20_022640_refine_gohr2_schema_from_dummy_data', 4),
(28, '2025_12_20_022754_finalize_names_for_dummy_import', 5);
...
INSERT INTO `positions` (`position_id`, `position_name`, `level`, `salary_grade`, `created_at`, `updated_at`) VALUES
(1, 'Power User', 'Entry', NULL, '2025-12-19 08:45:47', '2025-12-19 08:45:47'),
(2, 'HR', 'Entry', NULL, '2025-12-19 08:45:47', '2025-12-19 08:45:47'),
(3, 'Manager', 'Entry', NULL, '2025-12-19 08:45:47', '2025-12-19 08:45:47'),
(4, 'Developer', 'Entry', NULL, '2025-12-19 08:45:47', '2025-12-19 08:45:47');
...
INSERT INTO `presences` (`id`, `employee_id`, `check_in`, `check_out`, `latitude`, `longitude`, `work_type`, `date`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 4, '2025-12-12 21:21:18', NULL, NULL, NULL, 'WFH', '2025-12-13', 'present', '2025-12-12 21:21:18', '2025-12-12 21:21:18', NULL),
(2, 4, '2025-12-12 21:21:26', NULL, NULL, NULL, 'WFA', '2025-12-13', 'present', '2025-12-12 21:21:26', '2025-12-12 21:21:26', NULL);
...
('8lxK5o6rqyOh6X8F9ol0pox26FnA8aZm3AKiAnhP', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765619668),
('DIJ8lHiHDeMgCtz3gwkzQrJXl6CkOwC9rtA7J8rU', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36 Edg/143.0.0.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiQkJOSkl6aHNXR2FWQXpIRGY3RlZPZ1V3VGJ3a0FuWlM4aFJDWUxYSyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1765459736),
...
('QtxnM8Ahn3WTq5yT6ABQJbwJLoa9jeVgELnjuVZB', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765598013),
('rd2ZT3O93XHCY6aGg2e3PBuJVBmLPM4BpWN5nYLT', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765608064),
('vqDoEH6wYafIa5ZvH3V2dpqXvqyOeRTxgUCzK1Ff', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36 Edg/143.0.0.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiQTJhVjd3emF0YW9RaDNDcTgxVmFTcTRmM0JEYkVGdVZFRVpwd0pyWiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1765597152),
('WfUjuDWM4SzAYIMVLjMZYo6d2WU2O1yEFRhW5qq0', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36 Edg/143.0.0.0', '', 1765594484),
...
('zd1COOZKfF69F1Kkj0SBMKL2kjqkhsnk4CK4iIUQ', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36 Edg/143.0.0.0', '', 1765603568),
...
(1, 'Complete API Documentation', 'Write comprehensive API documentation', NULL, '2025-12-13 11:13:32', 'pending', '2025-12-06 11:13:32', '2025-12-16 07:59:25', '2025-12-16 07:59:25'),
...
(7, 'adada', 'tes@example.com', NULL, '$2y$12$D2nRBlONg.WgsXt8K33I7egKnMvaAJKmlF4Ut4C5aisJGlIUKoQGC', NULL, '2025-12-19 09:46:58', '2025-12-19 09:46:58', '7');
...
--
-- Table structure for table `user_type_roles`
--
...
ALTER TABLE `approval_types`
  ADD PRIMARY KEY (`id`),
  ADD KEY `approval_types_category_approval_id_foreign` (`category_approval_id`);
...
ALTER TABLE `bank_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bank_accounts_employee_id_foreign` (`employee_id`);
...
--
-- Indexes for table `category_approvals`
--
...
--
-- Indexes for table `departments_v2`
--
ALTER TABLE `departments_v2`
  ADD PRIMARY KEY (`department_id`);

--
-- Indexes for table `document_identities`
--
ALTER TABLE `document_identities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `document_identities_employee_id_foreign` (`employee_id`),
  ADD KEY `document_identities_identity_type_id_foreign` (`identity_type_id`);
...
--
-- Indexes for table `employees_v2`
--
ALTER TABLE `employees_v2`
  ADD PRIMARY KEY (`employee_id`),
  ADD UNIQUE KEY `employees_v2_emp_code_unique` (`emp_code`),
  ADD UNIQUE KEY `employees_v2_email_unique` (`email`),
  ADD KEY `employees_v2_foundation_id_foreign` (`foundation_id`),
  ADD KEY `employees_v2_education_level_id_foreign` (`education_level_id`);
...
--
-- Indexes for table `list_menu_features`
--
ALTER TABLE `list_menu_features`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_type_roles`
--
ALTER TABLE `user_type_roles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_type_roles_user_type_id_foreign` (`user_type_id`),
  ADD KEY `user_type_roles_role_id_foreign` (`role_id`);
...
--
-- AUTO_INCREMENT for table `category_approvals`
--
ALTER TABLE `category_approvals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `departments_v2`
--
ALTER TABLE `departments_v2`
  MODIFY `department_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `document_identities`
--
ALTER TABLE `document_identities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `education_levels`
  MODIFY `education_level_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `employees_v2`
--
ALTER TABLE `employees_v2`
...
--
ALTER TABLE `foundations`
  MODIFY `foundation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `identity_types`
--
ALTER TABLE `identity_types`
  MODIFY `identity_type_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `list_menu_features`
--
ALTER TABLE `list_menu_features`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_types`
  MODIFY `user_type_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `user_type_roles`
--
ALTER TABLE `user_type_roles`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `approval_types`
--
ALTER TABLE `approval_types`
  ADD CONSTRAINT `approval_types_category_approval_id_foreign` FOREIGN KEY (`category_approval_id`) REFERENCES `category_approvals` (`id`);

--
-- Constraints for table `attendances`
--
ALTER TABLE `attendances`
  ADD CONSTRAINT `attendances_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`);

--
-- Constraints for table `bank_accounts`
--
ALTER TABLE `bank_accounts`
  ADD CONSTRAINT `bank_accounts_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`);

--
-- Constraints for table `document_identities`
--
ALTER TABLE `document_identities`
  ADD CONSTRAINT `document_identities_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`),
  ADD CONSTRAINT `document_identities_identity_type_id_foreign` FOREIGN KEY (`identity_type_id`) REFERENCES `identity_types` (`identity_type_id`);
...
--
-- Constraints for table `employees_v2`
--
ALTER TABLE `employees_v2`
  ADD CONSTRAINT `employees_v2_education_level_id_foreign` FOREIGN KEY (`education_level_id`) REFERENCES `education_levels` (`education_level_id`),
  ADD CONSTRAINT `employees_v2_foundation_id_foreign` FOREIGN KEY (`foundation_id`) REFERENCES `foundations` (`foundation_id`);

--
-- Constraints for table `employee_families`
--
ALTER TABLE `employee_families`
  ADD CONSTRAINT `employee_families_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`);
...
--
ALTER TABLE `employee_positions`
  ADD CONSTRAINT `employee_positions_department_id_foreign` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`),
  ADD CONSTRAINT `employee_positions_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`),
  ADD CONSTRAINT `employee_positions_position_id_foreign` FOREIGN KEY (`position_id`) REFERENCES `positions` (`position_id`);
...
--
ALTER TABLE `leaves`
  ADD CONSTRAINT `leaves_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`);
...
--
ALTER TABLE `salaries`
  ADD CONSTRAINT `salaries_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees_v2` (`employee_id`);
...
--
-- Constraints for table `user_type_roles`
--
ALTER TABLE `user_type_roles`
  ADD CONSTRAINT `user_type_roles_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`),
  ADD CONSTRAINT `user_type_roles_user_type_id_foreign` FOREIGN KEY (`user_type_id`) REFERENCES `user_types` (`user_type_id`);
COMMIT;
