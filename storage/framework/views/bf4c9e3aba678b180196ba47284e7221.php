...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted"><?php echo e($payroll->employee?->fullname ?? 'Unknown'); ?> — <?php echo e($payroll->period_label); ?></p>
            </div>
    ...
    <form action="<?php echo e(route('payrolls.update', $payroll->id)); ?>" method="POST" id="payroll-form">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="employee_id" id="employee_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($emp->id); ?>" data-salary="<?php echo e($emp->salary); ?>" <?php echo e(old('employee_id', $payroll->employee_id) == $emp->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="period_month" id="period_month" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($i+1); ?>" <?php echo e(old('period_month', $payroll->period_month) == ($i+1) ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="period_year" id="period_year" class="form-select" required>
                                <?php for($y = date('Y') - 2; $y <= date('Y') + 1; $y++): ?>
                                    <option value="<?php echo e($y); ?>" <?php echo e(old('period_year', $payroll->period_year) == $y ? 'selected' : ''); ?>><?php echo e($y); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="card shadow-sm mb-3 border-start border-success border-4">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="salary" id="salary" class="form-control calc-earning" value="<?php echo e(old('salary', (int)$payroll->salary)); ?>" min="0" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="transport_allowance" id="transport_allowance" class="form-control calc-earning" value="<?php echo e(old('transport_allowance', (int)$payroll->transport_allowance)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="meal_allowance" id="meal_allowance" class="form-control calc-earning" value="<?php echo e(old('meal_allowance', (int)$payroll->meal_allowance)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="position_allowance" id="position_allowance" class="form-control calc-earning" value="<?php echo e(old('position_allowance', (int)$payroll->position_allowance)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="overtime_hours" id="overtime_hours" class="form-control" value="<?php echo e(old('overtime_hours', $payroll->overtime_hours)); ?>" min="0" step="0.5">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="overtime_amount" id="overtime_amount" class="form-control calc-earning" value="<?php echo e(old('overtime_amount', (int)$payroll->overtime_amount)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="performance_bonus" id="performance_bonus" class="form-control calc-earning" value="<?php echo e(old('performance_bonus', (int)$payroll->performance_bonus)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="attendance_bonus" id="attendance_bonus" class="form-control calc-earning" value="<?php echo e(old('attendance_bonus', (int)$payroll->attendance_bonus)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="other_bonus" id="other_bonus" class="form-control calc-earning" value="<?php echo e(old('other_bonus', (int)$payroll->other_bonus)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="bonus_notes" id="bonus_notes" class="form-control" value="<?php echo e(old('bonus_notes', $payroll->bonus_notes)); ?>">
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="working_days" id="working_days" class="form-control" value="<?php echo e(old('working_days', $payroll->working_days)); ?>" min="0">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label for="days_present" class="form-label">Hari Hadir</label>
                            <input type="number" name="days_present" id="days_present" class="form-control" value="<?php echo e(old('days_present', $payroll->days_present)); ?>" min="0">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="late_count" id="late_count" class="form-control" value="<?php echo e(old('late_count', $payroll->late_count)); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="late_deduction" id="late_deduction" class="form-control calc-deduction" value="<?php echo e(old('late_deduction', (int)$payroll->late_deduction)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="absent_count" id="absent_count" class="form-control" value="<?php echo e(old('absent_count', $payroll->absent_count)); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="absent_deduction" id="absent_deduction" class="form-control calc-deduction" value="<?php echo e(old('absent_deduction', (int)$payroll->absent_deduction)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="penalty_amount" id="penalty_amount" class="form-control calc-deduction" value="<?php echo e(old('penalty_amount', (int)$payroll->penalty_amount)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="penalty_notes" id="penalty_notes" class="form-control" value="<?php echo e(old('penalty_notes', $payroll->penalty_notes)); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="bpjs_kes" id="bpjs_kes" class="form-control calc-deduction" value="<?php echo e(old('bpjs_kes', (int)$payroll->bpjs_kes)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="bpjs_tk" id="bpjs_tk" class="form-control calc-deduction" value="<?php echo e(old('bpjs_tk', (int)$payroll->bpjs_tk)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="pph21" id="pph21" class="form-control calc-deduction" value="<?php echo e(old('pph21', (int)$payroll->pph21)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="other_deduction" id="other_deduction" class="form-control calc-deduction" value="<?php echo e(old('other_deduction', (int)$payroll->other_deduction)); ?>" min="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="deduction_notes" id="deduction_notes" class="form-control" value="<?php echo e(old('deduction_notes', $payroll->deduction_notes)); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select name="status" id="status" class="form-select" required>
                                <option value="draft" <?php echo e(old('status', $payroll->status) == 'draft' ? 'selected' : ''); ?>>📝 Draft</option>
                                <option value="approved" <?php echo e(old('status', $payroll->status) == 'approved' ? 'selected' : ''); ?>>✅ Approved</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="pay_date" id="pay_date" class="form-control" value="<?php echo e(old('pay_date', $payroll->pay_date?->format('Y-m-d'))); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            <label for="notes" class="form-label">Catatan</label>
                            <input type="text" name="notes" id="notes" class="form-control" value="<?php echo e(old('notes', $payroll->notes)); ?>">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/payrolls/edit.blade.php ENDPATH**/ ?>