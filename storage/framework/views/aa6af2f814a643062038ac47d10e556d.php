                        ...
                        <form action="<?php echo e(route('roles.update', $role->id)); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    id="title"
                                    class="form-control"
                                    value="<?php echo e(old('title', $role->title)); ?>"
                                    required
                                >
                            </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/roles/edit.blade.php ENDPATH**/ ?>