...
<div class="page-heading">
    ...
    <div class="d-flex gap-2 mb-3 no-print">
        <a href="<?php echo e(route('payrolls.index')); ?>" class="btn btn-secondary btn-sm"><i class="bi bi-arrow-left"></i> Kembali</a>
        ...
        <?php if(in_array(session('role'), ['Super Admin', 'HR Administrator', 'Super Admin'])): ?>
            <a href="<?php echo e(route('payrolls.edit', $payroll->id)); ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i> Edit</a>
        <?php endif; ?>
        <span class="ms-auto"><?php echo $payroll->status_badge; ?></span>
    </div>
    ...
    <div class="card shadow-sm" id="print-area">
        <div class="card-body p-4 payslip-container">
            ...
            <div class="text-center mb-2 payslip-header">
                ...
                <p class="text-gray-300 mb-0" style="font-size: 0.82rem;">Periode: <?php echo e($payroll->period_label); ?></p>
            </div>
                ...
                <div class="col-6">
                    <table class="table table-borderless table-sm mb-0 slip-info-table">
                        <tr>
                            ...
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e($payroll->employee?->fullname ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-gray-300" style="padding: 2px 4px;">NIK</td>
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e($payroll->employee?->emp_code ?? $payroll->employee?->nik ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-gray-300" style="padding: 2px 4px;">Departemen</td>
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e($payroll->employee?->department?->name ?? '-'); ?></td>
                        </tr>
                    </table>
                </div>
                <div class="col-6">
                    <table class="table table-borderless table-sm mb-0 slip-info-table">
                        <tr>
                            ...
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e($payroll->employee?->employeePositions?->where('is_active', true)->first()?->position?->position_name ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-gray-300" style="padding: 2px 4px;">Tanggal Bayar</td>
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e($payroll->pay_date?->format('d F Y') ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-bold text-gray-300" style="padding: 2px 4px;">Status</td>
                            <td class="text-white" style="padding: 2px 4px;">: <?php echo e(ucfirst($payroll->status ?? 'draft')); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
                    ...
                    <div class="border rounded p-2 h-100 payslip-dark-success">
                        ...
                        <table class="table table-sm table-borderless mb-0 slip-table">
                            <tr>
                                ...
                                <td class="text-end fw-bold text-white">Rp <?php echo e(number_format($payroll->salary, 0, ',', '.')); ?></td>
                            </tr>
                            <?php if($payroll->transport_allowance > 0): ?>
                            <tr>
                                <td class="text-gray-300">Tunjangan Transport</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->transport_allowance, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->meal_allowance > 0): ?>
                            <tr>
                                <td class="text-gray-300">Tunjangan Makan</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->meal_allowance, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->position_allowance > 0): ?>
                            <tr>
                                <td class="text-gray-300">Tunjangan Jabatan</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->position_allowance, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->overtime_amount > 0): ?>
                            <tr>
                                <td class="text-gray-300">Lembur (<?php echo e($payroll->overtime_hours); ?> jam)</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->overtime_amount, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->performance_bonus > 0): ?>
                            <tr>
                                <td class="text-gray-300">Bonus Kinerja</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->performance_bonus, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->attendance_bonus > 0): ?>
                            <tr>
                                <td class="text-gray-300">Bonus Kehadiran</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->attendance_bonus, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->other_bonus > 0): ?>
                            <tr>
                                <td class="text-gray-300">Bonus Lainnya</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->other_bonus, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->bonus_notes): ?>
                            <tr>
                                <td colspan="2" class="text-gray-400" style="font-size: 0.72rem; padding-top:0;"><em><?php echo e($payroll->bonus_notes); ?></em></td>
                            </tr>
                            <?php endif; ?>
                            <tr class="border-top border-green-600">
                                <td class="fw-bold text-green-400">Total Pendapatan</td>
                                <td class="text-end fw-bold text-green-400">Rp <?php echo e(number_format($payroll->total_earnings, 0, ',', '.')); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="border rounded p-2 h-100 payslip-dark-danger">
                        ...
                        <table class="table table-sm table-borderless mb-0 slip-table">
                            ...
                            <tr>
                                <td class="text-gray-300">Pot. Telat (<?php echo e($payroll->late_count); ?>×)</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->late_deduction, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->absent_deduction > 0): ?>
                            <tr>
                                <td class="text-gray-300">Pot. Absen (<?php echo e($payroll->absent_count); ?> hari)</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->absent_deduction, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->penalty_amount > 0): ?>
                            <tr>
                                <td class="text-gray-300">Denda/Penalti</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->penalty_amount, 0, ',', '.')); ?></td>
                            </tr>
                            <?php if($payroll->penalty_notes): ?>
                            <tr>
                                <td colspan="2" class="text-gray-400" style="font-size: 0.72rem; padding-top:0;"><em><?php echo e($payroll->penalty_notes); ?></em></td>
                            </tr>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if($payroll->bpjs_kes > 0): ?>
                            <tr>
                                <td class="text-gray-300">BPJS Kesehatan</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->bpjs_kes, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->bpjs_tk > 0): ?>
                            <tr>
                                <td class="text-gray-300">BPJS Ketenagakerjaan</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->bpjs_tk, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->pph21 > 0): ?>
                            <tr>
                                <td class="text-gray-300">PPh 21</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->pph21, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if($payroll->other_deduction > 0): ?>
                            <tr>
                                <td class="text-gray-300">Potongan Lain</td>
                                <td class="text-end text-white">Rp <?php echo e(number_format($payroll->other_deduction, 0, ',', '.')); ?></td>
                            </tr>
                            <?php if($payroll->deduction_notes): ?>
                            <tr>
                                <td colspan="2" class="text-gray-400" style="font-size: 0.72rem; padding-top:0;"><em><?php echo e($payroll->deduction_notes); ?></em></td>
                            </tr>
                            <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <tr class="border-top border-red-600">
                                ...
                                <td class="text-end fw-bold text-red-400">Rp <?php echo e(number_format($payroll->total_deductions, 0, ',', '.')); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="mt-2">
                <div class="border rounded py-1 px-2 payslip-dark-info" style="font-size: 0.78rem;">
                    ...
                    Hari Kerja: <strong class="text-white"><?php echo e($payroll->working_days); ?></strong> |
                    Hadir: <strong class="text-white"><?php echo e($payroll->days_present); ?></strong> |
                    Telat: <strong class="text-white"><?php echo e($payroll->late_count); ?></strong> |
                    Absen: <strong class="text-white"><?php echo e($payroll->absent_count); ?></strong>
                </div>
            </div>
            <?php endif; ?>
                    ...
                    <div class="border rounded p-2 payslip-dark-primary">
                        <table class="table table-sm table-borderless mb-0 slip-table">
                            <tr>
                                ...
                                <td class="text-end text-green-400 fw-bold">Rp <?php echo e(number_format($payroll->total_earnings, 0, ',', '.')); ?></td>
                            </tr>
                            <tr>
                                <td class="fw-bold text-gray-300">Total Potongan</td>
                                <td class="text-end text-red-400 fw-bold">- Rp <?php echo e(number_format($payroll->total_deductions, 0, ',', '.')); ?></td>
                            </tr>
                            <tr class="border-top border-2 border-blue-500">
                                <td class="fw-bold text-white" style="font-size: 1.05rem;">GAJI BERSIH</td>
                                <td class="text-end fw-bold text-cyan-400" style="font-size: 1.05rem;">Rp <?php echo e(number_format($payroll->net_salary, 0, ',', '.')); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="mt-2">
                <p class="text-gray-400 mb-0" style="font-size: 0.78rem;"><strong class="text-gray-300">Catatan:</strong> <?php echo e($payroll->notes); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div class="row text-center signature-area">
                <div class="col-4">
                    ...
                    <p class="border-top d-inline-block mb-0" style="min-width: 140px;">
                        <strong class="text-white"><?php echo e($payroll->employee?->fullname ?? '________________'); ?></strong><br>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/payrolls/show.blade.php ENDPATH**/ ?>