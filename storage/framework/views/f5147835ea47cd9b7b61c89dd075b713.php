...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-12">
            <a href="<?php echo e(route('signatures.list', ['signable' => $signable, 'id' => $id])); ?>" class="btn btn-secondary">Back to Signatures</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="signatureForm" method="POST" action="<?php echo e(route('signatures.store', ['signable' => $signable, 'id' => $id])); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('signatures.list', ['signable' => $signable, 'id' => $id])); ?>" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($model instanceof App\Models\Letter): ?>
                        <p><strong>Document Type:</strong> Letter</p>
                        <p><strong>Letter Number:</strong> <?php echo e($model->letter_number ?? 'Draft'); ?></p>
                        <p><strong>Subject:</strong> <?php echo e($model->subject); ?></p>
                        <p><strong>Status:</strong> <span class="badge bg-<?php echo e($model->status === 'approved' ? 'success' : 'warning'); ?>"><?php echo e(ucfirst($model->status)); ?></span></p>
                        <p><strong>Signer:</strong> <?php echo e(Auth::user()->name); ?></p>
                        <p><strong>Date:</strong> <?php echo e(now()->format('d M Y H:i')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
...
<script src="<?php echo e(asset('vendor/signature-pad/signature_pad.umd.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/signatures/pad.blade.php ENDPATH**/ ?>