            ...
            <tr>
                <td style="width: 70%; vertical-align: bottom; text-align: left; font-size: 8px; color: #777;">
                    ...
                    <div style="border-left: 2px solid #ddd; padding-left: 8px;">
                        ...
                        <?php echo e($config->company_name ?? 'PT Aratech Indonesia'); ?>
                ...
                <td style="width: 30%; text-align: right; vertical-align: top;">
                    <div style="display: inline-block; text-align: center;">
                        <img
                            alt="QR Verifikasi"
                            src="data:image/png;base64,<?php echo e(base64_encode(QrCode::format('png')->size(80)->margin(0)->errorCorrection('M')->generate($verificationUrl))); ?>"
                            width="80" height="80"
...
<?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/signatures/signed-letter-pdf.blade.php ENDPATH**/ ?>