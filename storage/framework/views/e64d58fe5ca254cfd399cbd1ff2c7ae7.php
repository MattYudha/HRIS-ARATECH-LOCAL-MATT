    ...
    function drawChart() {
        ...
        var rows = [
            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                [
                    {
                        'v': '<?php echo e($dept->id); ?>',
                        'f': `<div class="p-2 border rounded shadow-sm bg-white" style="min-width: 120px;">
                                <div class="fw-bold text-primary mb-1"><?php echo e($dept->name); ?></div>
                                <div class="small text-muted mb-1">
                                    <i class="bi bi-person-badge"></i> <?php echo e($dept->manager ? $dept->manager->fullname : 'No Manager'); ?>

                                </div>
                                <div class="badge bg-light text-dark border">
                                    <i class="bi bi-people"></i> <?php echo e($dept->employees->count()); ?>

                                </div>
                              </div>`
                    },
                    '<?php echo e($dept->parent_id ?? ""); ?>',
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/departments/org_chart.blade.php ENDPATH**/ ?>