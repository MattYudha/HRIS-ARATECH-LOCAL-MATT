...
<div class="page-heading mb-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('inventory-dispatches.create')); ?>" class="btn btn-primary">
...
<script>
    $(function() {
        $('#dispatch-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('inventory-dispatches.index')); ?>",
            columns: [
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aratechnology-hris/htdocs/hr-app/resources/views/inventory_dispatches/index.blade.php ENDPATH**/ ?>