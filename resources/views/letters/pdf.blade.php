...
<body>
    ...
    <div class="closing">
        ...
        <div class="signer">
            <strong>{{ $letter->approver?->name ?? 'HR Administrator Manager / Unit Head' }}</strong><br>
            <span class="signer-title">{{ $letter->approver?->employee?->role?->title ?? 'Human Resources' }}</span>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        @endif
        <div>
            Dicetak dari Sistem HRIS {{ $config->company_name ?? 'PT Aratech Indonesia' }} |
