...
<head>
    ...
    <style>
        ...
        .btn-premium:hover { transform: translateY(-2px); box-shadow: 0 10px 20px rgba(245, 54, 92, 0.3); color: #fff; }
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">
            Sistem kami sedang mengalami kendala teknis. Kami telah mencatat kesalahan ini dan akan segera memperbaikinya.
        </p>
